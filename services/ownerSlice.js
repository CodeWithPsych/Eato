...
export const fetchDashboardStatsAsync = createAsyncThunk(
  ...
  async (restaurantId, { rejectWithValue }) => {
    try { return (await fetchDashboardStats(restaurantId)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const fetchOwnerMenuAsync = createAsyncThunk(
  "owner/fetchMenu",
  async (restaurantId, { rejectWithValue }) => {
    try { return (await fetchOwnerMenu(restaurantId)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const addMenuItemAsync = createAsyncThunk(
  ...
  async ({ restaurantId, item }, { rejectWithValue }) => {
    try { return (await addMenuItem(restaurantId, item)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const editMenuItemAsync = createAsyncThunk(
  ...
  async ({ restaurantId, itemId, updates }, { rejectWithValue }) => {
    try { return (await editMenuItem(restaurantId, itemId, updates)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const deleteMenuItemAsync = createAsyncThunk(
  ...
  async ({ restaurantId, itemId }, { rejectWithValue }) => {
    try { return (await deleteMenuItem(restaurantId, itemId)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const fetchOwnerCategoriesAsync = createAsyncThunk(
  ...
  async (restaurantId, { rejectWithValue }) => {
    try { return (await fetchOwnerCategories(restaurantId)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const addCategoryAsync = createAsyncThunk(
  ...
  async ({ restaurantId, categoryName }, { rejectWithValue }) => {
    try { return (await addCategory(restaurantId, categoryName)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const deleteCategoryAsync = createAsyncThunk(
  ...
  async ({ restaurantId, categoryName }, { rejectWithValue }) => {
    try { return (await deleteCategory(restaurantId, categoryName)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const fetchChefsAsync = createAsyncThunk(
  "owner/fetchChefs",
  async (restaurantId, { rejectWithValue }) => {
    try { return (await fetchChefs(restaurantId)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const addChefAsync = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try { return (await addChef(data)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
...
export const deleteChefAsync = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try { return (await deleteChef(id)).data; }
    catch (e) { return rejectWithValue(serializeError(e)); }
  }
);
