  ...
  const handleDeleteItem = (item) => {
    Alert.alert("Delete Item", `Remove "${item.name}" from the menu?`, [
      { text: "Cancel", style: "cancel" },
      {
        text: "Delete",
        style: "destructive",
        onPress: () => dispatch(deleteMenuItemAsync({ restaurantId, itemId: item.id })),
      },
    ]);
  };
  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center mb-3">
        <Text className="text-neutral-800 font-quicksand-semibold">Categories</Text>
      </View>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-6">
        ...
        >
          <Text className={selectedCategory === null ? "text-white text-sm" : "text-neutral-700 text-sm"}>
            All
          </Text>
        </TouchableOpacity>
        {categories.map((cat) => (
          ...
          >
            <Text className={selectedCategory === cat ? "text-white text-sm" : "text-neutral-700 text-sm"}>
              {cat}
            </Text>
          </TouchableOpacity>
        ))}
        ...
        <View key={item.id} className="bg-white rounded-2xl p-4 mb-4 shadow-sm border border-neutral-100">
          <View className="flex-row gap-3">
            ...
            <View className="flex-1">
              ...
              <Text className="text-purple-600 mt-2 font-quicksand-semibold">Rs {item.price}</Text>
            </View>
          </View>
        </View>
      ))}
        ...
        <View className="flex-1 justify-end bg-black/40">
          <View className="bg-white rounded-t-3xl p-6">
            ...
            <View className="flex-row gap-3">
              ...
              <TouchableOpacity onPress={handleAddItem} className="flex-1 bg-purple-600 py-3 rounded-xl">
        ...
        <View className="flex-1 justify-end bg-black/40">
          <View className="bg-white rounded-t-3xl p-6">
            ...
            <View className="flex-row gap-3">
              ...
              <TouchableOpacity onPress={handleEditItem} className="flex-1 bg-purple-600 py-3 rounded-xl">
